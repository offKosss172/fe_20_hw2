...
- не все ошибки можно отследить через трай кетч, ловятся только те ошибки которые возникают при выполнении кода 
    - синтаксичный ошибки не могут быть отловлены с помощью трай-кетч
    - не отловятся ошибки в асинхронном коде - например с использованием функции СетТаймаут, так как она выполняется асинхронно через время
